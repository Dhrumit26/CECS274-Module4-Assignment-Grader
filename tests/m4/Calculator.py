...
stores the given mathematical variable and its corresponding value.
        If the variable already exists and should not be replaced, error message is printed and the variable is not
        stored.  Otherwise, the value of the existing variable is replaced with the new value.
        :param variable: str type;
        :param value: float type;
        :param replace: boolean type; if True, replaces the value of an existing variable
        """
